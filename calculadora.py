...
# columnspan = 4 "abarcara 4 columnas", padx = 50 "espacio en blanco en X"
#pady = 5 "espacio en blanco en Y"
...
boton_pare1 = Button(ventana, text = "(", width = 5, height = 2, command = lambda: click_boton ("("))
boton_pare2 = Button(ventana, text = ")", width = 5, height = 2, command = lambda: click_boton (")"))
...
boton_pare1.grid(row = 1, column = 1, padx = 5, pady = 5)
boton_pare2.grid(row = 1, column = 2, padx = 5, pady = 5)
